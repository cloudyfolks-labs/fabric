...
type NAT interface {
	...
	AddNat(lrName, natType, externalIP, logicalIP, logicalMac, port, gatewayPort string, options map[string]string) error
	EnsureNatGatewayPort(lrName, natType, externalIP, logicalIP, gatewayPort string) error
