...
func NewLoadBalancerLister(indexer cache.Indexer) LoadBalancerLister {
	return &loadBalancerLister{listers.New[*fabricv1.LoadBalancer](indexer, fabricv1.Resource("loadbalancer"))}
}
