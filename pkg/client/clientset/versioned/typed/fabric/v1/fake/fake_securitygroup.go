...
type fakeSecurityGroups struct {
	*gentype.FakeClientWithListAndApply[*v1.SecurityGroup, *v1.SecurityGroupList, *fabricv1.SecurityGroupApplyConfiguration]
	Fake *FakeFabricV1
}

func newFakeSecurityGroups(fake *FakeFabricV1) typedfabricv1.SecurityGroupInterface {
	return &fakeSecurityGroups{
		gentype.NewFakeClientWithListAndApply[*v1.SecurityGroup, *v1.SecurityGroupList, *fabricv1.SecurityGroupApplyConfiguration](
			fake.Fake,
			"",
