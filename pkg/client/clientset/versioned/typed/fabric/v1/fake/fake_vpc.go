...
type fakeVpcs struct {
	*gentype.FakeClientWithListAndApply[*v1.Vpc, *v1.VpcList, *fabricv1.VpcApplyConfiguration]
	Fake *FakeFabricV1
}

func newFakeVpcs(fake *FakeFabricV1) typedfabricv1.VpcInterface {
	return &fakeVpcs{
		gentype.NewFakeClientWithListAndApply[*v1.Vpc, *v1.VpcList, *fabricv1.VpcApplyConfiguration](
			fake.Fake,
			"",
