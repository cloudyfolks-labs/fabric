...
type fakeIPs struct {
	*gentype.FakeClientWithListAndApply[*v1.IP, *v1.IPList, *fabricv1.IPApplyConfiguration]
	Fake *FakeFabricV1
}

func newFakeIPs(fake *FakeFabricV1) typedfabricv1.IPInterface {
	return &fakeIPs{
		gentype.NewFakeClientWithListAndApply[*v1.IP, *v1.IPList, *fabricv1.IPApplyConfiguration](
			fake.Fake,
			"",
