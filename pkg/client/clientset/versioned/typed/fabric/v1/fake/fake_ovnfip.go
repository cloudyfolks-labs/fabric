...
type fakeOvnFips struct {
	*gentype.FakeClientWithListAndApply[*v1.OvnFip, *v1.OvnFipList, *fabricv1.OvnFipApplyConfiguration]
	Fake *FakeFabricV1
}

func newFakeOvnFips(fake *FakeFabricV1) typedfabricv1.OvnFipInterface {
	return &fakeOvnFips{
		gentype.NewFakeClientWithListAndApply[*v1.OvnFip, *v1.OvnFipList, *fabricv1.OvnFipApplyConfiguration](
			fake.Fake,
			"",
