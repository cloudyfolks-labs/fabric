...
func (f *dNSZoneInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisfabricv1.DNSZone{}, f.defaultInformer)
}

func (f *dNSZoneInformer) Lister() fabricv1.DNSZoneLister {
	return fabricv1.NewDNSZoneLister(f.Informer().GetIndexer())
}
