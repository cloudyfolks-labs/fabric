...
type LoadBalancerInformer interface {
	...
	Lister() fabricv1.LoadBalancerLister
}
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisfabricv1.LoadBalancer{}, f.defaultInformer)
}

func (f *loadBalancerInformer) Lister() fabricv1.LoadBalancerLister {
	return fabricv1.NewLoadBalancerLister(f.Informer().GetIndexer())
}
