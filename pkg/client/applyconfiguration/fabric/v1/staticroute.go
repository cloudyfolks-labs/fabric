...
type StaticRouteApplyConfiguration struct {
	Policy     *fabricv1.RoutePolicy `json:"policy,omitempty"`
...
func (b *StaticRouteApplyConfiguration) WithPolicy(value fabricv1.RoutePolicy) *StaticRouteApplyConfiguration {
	b.Policy = &value
	return b
}
