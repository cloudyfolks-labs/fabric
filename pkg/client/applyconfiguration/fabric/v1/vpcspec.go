...
type VpcSpecApplyConfiguration struct {
	...
	StaticRoutes []*fabricv1.StaticRoute `json:"staticRoutes,omitempty"`
	// Policy routes for the VPC.
	PolicyRoutes []*fabricv1.PolicyRoute `json:"policyRoutes,omitempty"`
	// VPC peering configurations.
	VpcPeerings []*fabricv1.VpcPeering `json:"vpcPeerings,omitempty"`
...
func (b *VpcSpecApplyConfiguration) WithStaticRoutes(values ...**fabricv1.StaticRoute) *VpcSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *VpcSpecApplyConfiguration) WithPolicyRoutes(values ...**fabricv1.PolicyRoute) *VpcSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *VpcSpecApplyConfiguration) WithVpcPeerings(values ...**fabricv1.VpcPeering) *VpcSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
