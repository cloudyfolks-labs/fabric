...
func (b *LoadBalancerStatusApplyConfiguration) WithConditions(values ...*ConditionApplyConfiguration) *LoadBalancerStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *LoadBalancerStatusApplyConfiguration) WithVip(value string) *LoadBalancerStatusApplyConfiguration {
	b.Vip = &value
	return b
}
...
func (b *LoadBalancerStatusApplyConfiguration) WithPorts(value string) *LoadBalancerStatusApplyConfiguration {
	b.Ports = &value
	return b
}
...
func (b *LoadBalancerStatusApplyConfiguration) WithService(value string) *LoadBalancerStatusApplyConfiguration {
	b.Service = &value
	return b
}
