...
type PolicyRouteApplyConfiguration struct {
	...
	Action *fabricv1.PolicyRouteAction `json:"action,omitempty"`
...
func (b *PolicyRouteApplyConfiguration) WithAction(value fabricv1.PolicyRouteAction) *PolicyRouteApplyConfiguration {
	b.Action = &value
	return b
}
