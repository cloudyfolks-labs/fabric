...
type VpcDynamicRoutingApplyConfiguration struct {
	...
	Redistribute []fabricv1.RedistributeType `json:"redistribute,omitempty"`
...
func (b *VpcDynamicRoutingApplyConfiguration) WithRedistribute(values ...fabricv1.RedistributeType) *VpcDynamicRoutingApplyConfiguration {
	for i := range values {
