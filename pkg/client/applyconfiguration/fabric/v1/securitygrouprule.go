...
type SecurityGroupRuleApplyConfiguration struct {
	...
	Protocol *fabricv1.SgProtocol `json:"protocol,omitempty"`
	// Rule priority (1-16384)
	Priority *int `json:"priority,omitempty"`
	// Type of remote (address, cidr, or securityGroup)
	RemoteType *fabricv1.SgRemoteType `json:"remoteType,omitempty"`
	...
	Policy *fabricv1.SgPolicy `json:"policy,omitempty"`
}
...
func (b *SecurityGroupRuleApplyConfiguration) WithProtocol(value fabricv1.SgProtocol) *SecurityGroupRuleApplyConfiguration {
	b.Protocol = &value
	return b
}
...
func (b *SecurityGroupRuleApplyConfiguration) WithRemoteType(value fabricv1.SgRemoteType) *SecurityGroupRuleApplyConfiguration {
	b.RemoteType = &value
	return b
}
...
func (b *SecurityGroupRuleApplyConfiguration) WithPolicy(value fabricv1.SgPolicy) *SecurityGroupRuleApplyConfiguration {
	b.Policy = &value
	return b
}
