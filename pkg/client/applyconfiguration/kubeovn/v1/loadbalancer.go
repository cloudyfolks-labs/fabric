...
// apply.
func LoadBalancer(name string) *LoadBalancerApplyConfiguration {
...
func (b *LoadBalancerApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *LoadBalancerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *LoadBalancerApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *LoadBalancerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *LoadBalancerApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *LoadBalancerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
