...
func (b *LoadBalancerPortApplyConfiguration) WithName(value string) *LoadBalancerPortApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *LoadBalancerPortApplyConfiguration) WithTargetPort(value int32) *LoadBalancerPortApplyConfiguration {
	b.TargetPort = &value
	return b
}
...
func (b *LoadBalancerPortApplyConfiguration) WithProtocol(value string) *LoadBalancerPortApplyConfiguration {
	b.Protocol = &value
	return b
}
