...
require_line "$TMP_DIR/mgmt-values.yaml" "central:"
...
require_line "$TMP_DIR/tenant-values.yaml" "central:"
...
require_count "$TMP_DIR/mgmt-kind-ha.yaml" 3 "      fabric/tenant-control-plane: \"true\""
...
require_line "$TMP_DIR/tenant-tcp-ha.yaml" "        fabric/tenant-control-plane: \"true\""
...
require_line "$TMP_DIR/tenant-values-ipv4.yaml" "  stack: IPv4"
...
require_line "$TMP_DIR/mgmt-values-ipv6.yaml" "  stack: IPv4"
require_line "$TMP_DIR/tenant-values-ipv6.yaml" "  stack: IPv6"
...
require_line "$TMP_DIR/mgmt-values-dual.yaml" "  stack: IPv4"
require_line "$TMP_DIR/tenant-values-dual.yaml" "  stack: Dual"
...
require_line "$TMP_DIR/tenant-kubeovn-image" "docker.io/cloudyfolks-labs/fabric:dev"
...
require_text "$SCRIPT" "Patching fabric-pinger for IPv6-only tenant bootstrap"
